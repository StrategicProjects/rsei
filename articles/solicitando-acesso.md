...
# Guarde a chave fora do código (keyring); faça isso uma vez por máquina.
store_sei_credentials(identificacao_servico = "SUA_CHAVE_DE_ACESSO")

cfg <- sei_config(
  sei_url               = "https://sei.exemplo.gov.br/sei/ws/SeiWS.php",
  sigla_sistema         = "MEU_SISTEMA",
  identificacao_servico = get_sei_credentials()
)
